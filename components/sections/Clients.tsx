...
//       topIcon: <FaShieldAlt className="text-white w-8 h-8" />,
//     },
//     {
...
//             >
//               <div className="relative bg-[#171817] text-white p-6 md:p-10 rounded-xl border border-[#DDF694] shadow-[0_0_30px_#6F7C4E] ring-0 ring-lime-100 max-w-xl w-full mx-auto">
//                 {/* Top Icon */}
//                 <div
//                   ref={(el) => {
  ...
  const cardData = [
    {
      ...
      description:
        'Through jaw-dropping design, our websites instantly capture attention and prove your expertise.',
      topIcon: <FaPenNib className="text-[#D3D3D3] w-12 h-12  md:w-16 md:h-16" />,
      bottomIcon: <FaPaintBrush className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
    },
    {
      title: 'Boosting Conversion Rates',
      description:
        'We build high-converting landing pages that turn visitors into loyal customers.',
      topIcon: <FaChartLine className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
      bottomIcon: <FaRocket className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
    },
    {
      title: 'Establishing Trust Instantly',
      description:
        'Clear messaging and elegant design builds trust with high-end clients from the first glance.',
      topIcon: <FaShieldAlt className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
      bottomIcon: <FaHandshake className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
    },
    {
      title: 'Streamlining the Journey',
      description:
        'Intuitive navigation and layout help users find what they need, fast — leading to better outcomes.',
      topIcon: <FaCompass className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
      bottomIcon: <FaRoute className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
    },
    {
      title: 'Highlighting Your Value',
      description:
        'We position your brand as the premium choice through compelling copy and visuals.',
      topIcon: <FaLightbulb className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
      bottomIcon: <FaStar className="text-[#D3D3D3] w-12 h-12 md:w-16 md:h-16" />,
    },
  ];
            ...
            >
              <div className="relative bg-[#171817] text-white p-6 md:p-10 rounded-xl border border-[#DDF694] shadow-[0_0_30px_#6F7C4E] ring-0 ring-lime-100 max-w-xl w-full mx-auto">
                ...
                <div
                  ...
                  className="absolute -top-5 -left-5 rounded-full p-2 shadow-lg opacity-0"
                >
                  {card.topIcon}
                </div>
                ...
                <div
                  ...
                  className="absolute -bottom-5 -right-5  rounded-full p-2 shadow-lg opacity-0"
                >
                  {card.bottomIcon}
                </div>
              </div>
